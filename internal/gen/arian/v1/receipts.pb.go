...
const file_arian_v1_receipts_proto_rawDesc = "" +
	...
	"\t_merchantB\x10\n" +
	"\x0e_purchase_dateB\x0f\n" +
	"\r_total_amountB\x87\x01\n" +
	"\fcom.arian.v1B\rReceiptsProtoP\x01Z'arian-tui/internal/gen/arian/v1;arianv1\xa2\x02\x03AXX\xaa\x02\bArian.V1\xca\x02\bArian\\V1\xe2\x02\x14Arian\\V1\\GPBMetadata\xea\x02\tArian::V1b\x06proto3"
